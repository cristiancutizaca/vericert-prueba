...
const StudentForm: React.FC<StudentFormProps> = ({ id, onCloseModal, onUpdateSuccess }) => {
  ...
  return (
    ...
    <div className="dark:bg-blackblue max-w-screen-lg mx-auto  p-4 rounded-lg">
      <h1 className='text-md  bg-primaryblue text-gray-100  p-2 rounded-lg mb-4 uppercase'>Actualizar estudiante</h1>
